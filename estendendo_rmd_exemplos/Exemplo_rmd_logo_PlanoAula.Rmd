...
a) Teste de hipóteses frequentistas e bayesianos também podem ser construídos com base nos intervalos de confiança e de credibilidade, respectivamente. Gere uma amostra de tamanho $n=1$ da distribuição $Beta(1,5; 1)$ e teste a hipótese $H_0 : \theta \leq 1$ contra $H_1: \theta > 1$.
